package com.shixincube.camerapicker;
...
import com.shixincube.camerapicker.listener.CaptureListener;
import com.shixincube.camerapicker.listener.ClickListener;
import com.shixincube.camerapicker.listener.ErrorListener;
import com.shixincube.camerapicker.listener.TypeListener;
import com.shixincube.camerapicker.state.CameraMachine;
import com.shixincube.camerapicker.util.FileUtil;
import com.shixincube.camerapicker.util.LogUtil;
import com.shixincube.camerapicker.util.ScreenUtils;

import java.io.IOException;

public class CameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder
        .Callback, com.shixincube.camerapicker.view.CameraView {
    ...
    public CameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // 默认为30s
        duration = a.getInteger(R.styleable.CameraView_durationMax, 30 * 1000);
        a.recycle();
        initData();
        initView();
    }
    ...
    private void initData() {
        ...
        LogUtil.i(TAG, "zoom = " + zoomGradient);
    ...
    private void initView() {
        ...
        mSwitchCamera.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                machine.swap(mVideoView.getHolder(), screenProp);
            }
        });
        //拍照 录像
