package com.shixincube.imagepicker.adapter;
...
import com.shixincube.imagepicker.Utils;
import com.shixincube.imagepicker.bean.ImageItem;
import com.shixincube.imagepicker.ui.ImageBaseActivity;
            ...
            holder.cbCheck.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (holder.cbCheck.isChecked() && mSelectedImages.size() >= selectLimit) {
                        Toast.makeText(mActivity.getApplicationContext(), mActivity.getString(R.string.select_limit, Integer.toString(selectLimit)), Toast.LENGTH_SHORT).show();
