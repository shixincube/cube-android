...
public class EmojiAdapter extends BaseAdapter {
    ...
    public EmojiAdapter(Context context, int emotionLayoutWidth, int emotionLayoutHeight, int startIndex) {
        ...
        mEmotionLayoutHeight = emotionLayoutHeight - EmotionKit.dip2px(35 + 26 + 50);//减去底部的tab高度、小圆点的高度才是viewpager的高度，再减少30dp是让表情整体的顶部和底部有个外间距
...
//        rl.setBackgroundColor(Color.RED);
        ...
        if (position == EmotionLayout.EMOJI_PER_PAGE || index == count) {
            emojiThumb.setBackgroundResource(R.mipmap.ic_emoji_del);
        } else if (index < count) {
