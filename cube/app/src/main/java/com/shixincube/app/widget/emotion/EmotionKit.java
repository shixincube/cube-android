...
public class EmotionKit {
    ...
    // 默认路径在 /data/data/包名/files/sticker 下
    ...
    public static void init(Context context, String stickerPath) {
        ...
        //将 assets/sticker 目录下默认的贴图复制到 STICKER_PATH下
    ...
    public static void init(Context context, String stickerPath, ImageLoader imageLoader) {
